...
if(!themify_check('setting-post_nav_disable')):
	...
	<div class="post-nav clearfix"> 
		<?php previous_post_link('<span class="prev">%link</span>', '%title', $in_same_cat, '', $this_taxonomy) ?>
		<?php next_post_link('<span class="next">%link</span>', '%title', $in_same_cat, '', $this_taxonomy) ?>
	</div>
	<!-- /post-nav -->
<?php endif; ?>