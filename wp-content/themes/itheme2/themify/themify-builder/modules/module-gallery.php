	...
	apply_filters( 'themify_builder_module_gallery', array(
		'options' => array(
			...
			array(
				...
				'options' => array(
					array('img' => 'grid4.png', 'value' => 'grid', 'label' => __('Grid', 'themify')),
					array('img' => 'showcase.png', 'value' => 'showcase', 'label' => __('Showcase', 'themify')),
				)
			),
			array(
			...
			array(
				...
				'class' => 'xsmall',
				'hide' => $this->is_img_php_disabled() ? true : false,
				'help' => 'px'
			),
			array(
				'id' => 'thumb_h_gallery',
