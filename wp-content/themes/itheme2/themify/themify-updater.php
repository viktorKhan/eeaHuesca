...
ow available. View the <a href="http://themify.me/logs/%s-changelogs" target="_blank">change log</a> for details.</p>', 'themify' ),
						$newT->url,
					...
					$theme_notifications = sprintf( __( '<p class="update %s">%s version %s is now available. <a href="%s" class="%s" target="%s">Update Now</a> or view the <a href="http://themify.me/logs/%s-changelogs" target="_blank">change log</a> for details.</p>', 'themify' ),
						$newT->login,
						$theme_label,
						$newT->version,
						$newT->url,
		...
		if ( is_object( $newF ) && ( THEMIFY_VERSION < $newF->version ) ) {
			if ( $_GET['page'] == 'themify' ) {
				if ( isset( $area ) && 'tab' == $area ) {
					...
					$fw_notifications = '<p class="update">' . sprintf( __( 'Framework version %s is now available. <a href="%s" title="" class="%s" target="%s">Update Now</a> or view the <a href="http://themify.me/logs/framework-changelogs">change log</a> for details.', 'themify' ),
							$newF->version,
							$newF->url,
			...
			if($update['_a']['name'] == 'themify' && !is_object($newF)){
				...
				if ( str_replace( '.', '', trim( THEMIFY_VERSION ) ) < $latest ) {
					...
					if ( isset( $area ) && 'tab' == $area ) {
						...
						$fw_notifications = sprintf( __( '<p class="update %s">Framework version %s is now available. <a href="%s" class="%s" target="%s">Update Now</a> or view the <a href="http://themify.me/logs/framework-changelogs" target="_blank">change log</a> for details.</p>', 'themify' ),
							$login,
							$update['_v'],
							$url,
							$class,
				...
				if(str_replace(".","",$theme_version) < $latest){
					...
					if ( isset( $area ) && 'tab' == $area ) {
						$theme_notifications = sprintf( __( "<a href='%s' title='' class='%s updateready' target='%s'>Update Now</a> <p class='update %s'>%s version %s is now available. View the <a href='http://themify.me/logs/%s-changelogs' title='' class='' target='_blank'>change log</a> for details.</p>", 'themify' ),
							$url,
							$class,
							$target,
							$login,
						...
						$theme_notifications = sprintf( __( "<p class='update %s'>%s version %s is now available. <a href='%s' title='' class='%s' target='%s'>Update Now</a> or view the <a href='http://themify.me/logs/%s-changelogs' title='' class='' target='_blank'>change log</a> for details.</p>", 'themify' ),
							$login,
							$theme_label,
							$update['_v'],
							$url,
